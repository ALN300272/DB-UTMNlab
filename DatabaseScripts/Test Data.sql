...
-- 5. Вставляем марки и модели автомобилей
...
-- 8. Вставляем документы с разными уровнями конфиденциальности
...
-- 9. Вставляем несколько уведомлений
